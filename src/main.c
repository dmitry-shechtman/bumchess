...
static inline
bool check_bishop(register square_t square, register dir_mask_t dir_mask, uint8_t color) {
...
static inline
bool check_rook(register square_t square, register dir_mask_t dir_mask, uint8_t color) {
